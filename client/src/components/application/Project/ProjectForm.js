    ...
    <form>
      ...
      <FormGroup className="required">
        ...
        <ValidatedComponent error={errors.summary}>
          <Textarea className="form-control" name="summary" rows={5} placeholder="Non confidentiel, ne doit pas comporter d'élément sensible" onChange={onChange} value={project.summary}/>
        </ValidatedComponent>
      </FormGroup>
      <FormGroup className="required">

  ...
  return (
    <div>
      <article className="text container">
        ...
        <p>
          Nous conservons ces données pendant 2 ans à compter de l’envoi de la candidature pour analyser les usages, mesurer l'impact et la diffusion territoriale du service Étudiant Entrepreneur, et améliorer le service.
          ...
          <small>Elles vous permettent également de renouveler votre candidature en copiant les informations de votre candidature précédente.</small>
        </p>
        <p>
